  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={colors.LinearGradient as [string, string, ...string[]]} style={styles.homeHeadgradient}>
        ...
        >
          <Image style={{ height: 32, width: 32, borderRadius: 50, borderWidth: 1 }} source={photo} />
        </TouchableOpacity>
      ...
      <View style={{ flex: 0.41, alignItems: "center", backgroundColor: colors.backgroundColor }}>
                ...
                >
                  <Text
                    style={[
                      styles.itemText,
                      {
                        color: isSelected ? "rgb(42, 124, 118)" : "rgba(145, 145, 159, 1)",
                        fontWeight: "700",
        ...
        {filteredAndSortedTransactions.length === 0 ? (
          <View style={{ flex: 0.6, justifyContent: "center", alignItems: "center", width: "90%" }}>
            <Text style={styles.budgetText}>{t("Start tracking your finances by making your first transaction.")}</Text>
          </View>
        ) : (
          <View style={{ width: "98%", flex: 1.2, alignItems: "center", justifyContent: "center" }}>
