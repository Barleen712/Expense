            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.notiView}>
                   ...
                   <Text style={styles.notiDes}>Get Notification when your budget exceeds limit</Text>
                    ...
                    <View style={styles.switch}>
                        <Switch trackColor={{false:'rgba(220, 234, 233, 0.6)',true:"rgb(42, 124, 118)"}} value={Budget} thumbColor={"white"} onValueChange={setBudget}/>
                    </View>
                </View>
                <View style={styles.Line}></View>
                <View style={styles.notiView}>
                   ...
                   <Text style={styles.notiDes}>Small & useful pieces of practical financial advice</Text>
                    ...
                    <View>
                        <Switch  style={styles.switch} trackColor={{false:'rgba(220, 234, 233, 0.6)',true:"rgb(42, 124, 118)"}} value={Tips} thumbColor={"white"} onValueChange={setTips}/>
                    </View>
                </View>
                <View style={styles.Line}></View>
            </SafeAreaView>
